...
(* Bit vectors *)
let bv_prefix = "SMTCoq.BVList.BITVECTOR_LIST"
...
(* Arrays *)
let array_prefix = "SMTCoq.FArray"
let array_gc = gc array_prefix
...
(* SMTCoq Classes *)
let classes_prefix = "SMTCoq.SMT_classes"
...
let classesi_prefix = "SMTCoq.SMT_classes_instances"
